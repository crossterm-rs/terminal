...
```rust
use terminal::{ClearType, Action, Value, Result, error};
...
- [Examples repository](https://github.com/terminal/examples)
...
License - see the [LICENSE](https://github.com/terminal/blob/master/LICENSE) file for details.
...
[s6]: https://tokei.rs/b1/github/terminal/?category=code
